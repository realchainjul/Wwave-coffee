...
-->
  <html>
      <head>
        ...
        <link rel="stylesheet" href="event_signature.css">
        </head>
        <body>
        <!--상단 메뉴바-->
        ...
        <div class="event">
            ...
            <div class="contents">
                <div class="board_top">
                    <p style="font-weight: bold;">Wwave 시그니처 커피 발매</p>
                    <p style="color: rgba(139, 131, 131, 0.87);">2023.06.03</p>
                </div>
                <div class="board">
                    <img src="image/event_01.jpg">
                </div>
            </div>
            <div class="notbtn" onclick="location.href='event.php';">
                <a href="event.php">목록보기</a>
            </div>
        </div>
        <!--본문-->
        <!--반응형 웹 스크립트-->
