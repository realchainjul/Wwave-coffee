  ...
  .navbar__toggleBtn li {
    ...
    <nav class="navigation">
        ...
        <article>
            <div class="store">
                <h1>Store Wwave</h1>
                <h2>“가끔은 배를 타며 즐기셔도 좋습니다.”</h2>
                <p>차별화된 드라이브 스루 매장에서 더욱 편리하게 Wwave 를 만나보세요.</p>
                ...
                <div class="contents">
                    <div class="contents_top">
                        ...
                        <div class="c_txt">
                            <p style="font-weight: bold;">드라이브스루 매장<br> </p>
                            <p>차별화된 드라이브 스루 매장에서 더욱 편리하게 Wwave 를 만나보세요.<br>배 안 가득히 퍼져나가는 커피향과 여운, Wwave 드라이브 스루 매장에서 함께 태워가세요!</p>
                            <p> Wwave **드라이브 스루(Drive Thru)는** 고객이 주차를 하지 않고 <br> 배를 탄 채로 Wwave 의 최고의 서비스를 편리하게 이용할 수 있는 서비스 입니다.<br> 이동 중에도 부담 없이 이용할 수 있으며, <br> Wwave  최초 Face to Face 화상 주문 시스템으로 <br> 주문과정에서 부터 결제까지 친절한 Wwave 파트너의 미소가 함께합니다.</p>
                            <p>본점: 제주, 1호점 : 태평양, 2호점: 북대서양, 3호점: 인도양, 4호점 :북극해</p>
